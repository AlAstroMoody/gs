import{a as e,b as a,d as s,r as l,o as q,s as G,O as F,c as y,v as O,P as N,Q as j,G as W,i as U,k as Q,F as z,j as V,g as m,t as I,e as C,l as k,p as Y,T as H,n as J,f as K,w as X,C as Z,_ as t}from"./index.55f217f3.js";import{a as n1,g as E,s as e1}from"./transitions.b67b51ec.js";import{s as p}from"./store.fd9f566f.js";import s1 from"./QuestionIcon.936152c4.js";import"./useGoblinState.14933650.js";const t1=["fill"],o1=s("g",{transform:"translate(0.000000,953.000000) scale(0.100000,-0.100000)",stroke:"none"},[s("path",{d:`M5564 9519 c-4 -8 -27 -9 -65 -5 l-59 6 -31 -42 -30 -42 7 -102 c6
...
-13 18 -12 24 7 47 23 31 41 34 63 11z`}),s("path",{d:`M6823 3024 c-7 -18 17 -38 31 -24 11 11 1 40 -14 40 -6 0 -13 -7 -17
-16z`})],-1),r1=[o1],$={__name:"SpiderIcon",props:{width:{default:40,type:Number},color:{default:"rgba(235, 235, 235, 0.64)",type:String}},setup(u){return(c,r)=>(e(),a("svg",{version:"1.0",xmlns:"http://www.w3.org/2000/svg",width:"1280.000000pt",viewBox:"0 0 1280.000000 953.000000",preserveAspectRatio:"xMidYMid meet",fill:u.color},r1,8,t1))}};var a1=Object.freeze(Object.defineProperty({__proto__:null,default:$},Symbol.toStringTag,{value:"Module"}));function c1(u){switch(u){case"../components/icons/bosses/DeathIcon.vue":return t(()=>import("./DeathIcon.a34def01.js"),["assets/DeathIcon.a34def01.js","assets/index.55f217f3.js","assets/index.13489f4b.css"]);case"../components/icons/bosses/ExcavatorIcon.vue":return t(()=>import("./ExcavatorIcon.7ccce7df.js"),["assets/ExcavatorIcon.7ccce7df.js","assets/index.55f217f3.js","assets/index.13489f4b.css"]);case"../components/icons/bosses/FearIcon.vue":return t(()=>import("./FearIcon.d39cde34.js"),["assets/FearIcon.d39cde34.js","assets/index.55f217f3.js","assets/index.13489f4b.css"]);case"../components/icons/bosses/GreedIcon.vue":return t(()=>import("./GreedIcon.454274b4.js"),["assets/GreedIcon.454274b4.js","assets/index.55f217f3.js","assets/index.13489f4b.css"]);case"../components/icons/bosses/GuardianIcon.vue":return t(()=>import("./GuardianIcon.1f439868.js"),["assets/GuardianIcon.1f439868.js","assets/index.55f217f3.js","assets/index.13489f4b.css"]);case"../components/icons/bosses/LustIcon.vue":return t(()=>import("./LustIcon.35aab728.js"),["assets/LustIcon.35aab728.js","assets/index.55f217f3.js","assets/index.13489f4b.css"]);case"../components/icons/bosses/ShizzlIcon.vue":return t(()=>import("./ShizzlIcon.379f3381.js"),["assets/ShizzlIcon.379f3381.js","assets/index.55f217f3.js","assets/index.13489f4b.css"]);case"../components/icons/bosses/SlaveOwnerIcon.vue":return t(()=>import("./SlaveOwnerIcon.f129a031.js"),["assets/SlaveOwnerIcon.f129a031.js","assets/index.55f217f3.js","assets/index.13489f4b.css"]);case"../components/icons/bosses/SpiderIcon.vue":return t(()=>Promise.resolve().then(function(){return a1}),void 0);default:return new Promise(function(c,r){(typeof queueMicrotask=="function"?queueMicrotask:setTimeout)(r.bind(null,new Error("Unknown variable dynamic import: "+u)))})}}const i1={class:"relative p-2"},l1=["onClick"],u1={class:"my-2"},_1=s("div",{class:"my-2"},"\u041E\u0441\u043E\u0431\u0435\u043D\u043D\u043E\u0441\u0442\u0438 \u0431\u043E\u0441\u0441\u0430:",-1),d1=["src"],w1={__name:"BossPage",async setup(u){var A,D;let c,r;const x=l(null),g=l(null),L=l(null),v=l(null);q(()=>{n1([x,g,L]),R(),E.from(v.value,{duration:1,width:0,scale:.1,autoAlpha:0,ease:"power1.out"})});const S=G(),B=F(),i=y(()=>p.entities.bosses);i.value.length||([c,r]=O(()=>p.setItems("bosses")),await c,r());const T=y(()=>p.entities.items);T.value.length||([c,r]=O(()=>p.setItems("items")),await c,r());const _=l((A=i.value[0])==null?void 0:A.id);S.query.name&&(_.value=(D=i.value.find(o=>o.name===S.query.name))==null?void 0:D.id);const P=o=>{var d;return(d=T.value.find(w=>w.id===o))==null?void 0:d.src},f=y(()=>i.value.find(o=>o.id===_.value)||i.value[0]),M={1:"Spider",2:"SlaveOwner",3:"Guardian",4:"Excavator",5:"Lust",7:"Greed",9:"Fear",12:"Shizzl",13:"Death"},h=N($);j(()=>{B.push({query:{name:f.value.name}});let o=M[_.value]||"Spider";c1(`../components/icons/bosses/${o}Icon.vue`).then(d=>{h.value=d.default})});const b=l(null);W(h,()=>{Z(()=>{R()})});const R=()=>{E.from(b.value.children[0],{duration:1,rotate:45,scale:.1,autoAlpha:0,ease:"back.out(1)"})};return U(()=>{e1({el:b.value.children[0],to:3}),E.to(v.value,{duration:1,width:0,scale:.1,autoAlpha:0})}),(o,d)=>{const w=Q("router-link");return e(),a("div",i1,[s("div",{class:"flex flex-wrap",ref_key:"bossList",ref:x},[(e(!0),a(z,null,V(m(i),n=>(e(),a("span",{onClick:m1=>_.value=n.id,key:n.id,class:J(["mx-2 my-1 whitespace-nowrap text-lg lg:text-xl",n.id===_.value?" underline":"text-purple"])},I(n.name),11,l1))),128))],512),s("hr",{class:"border-b border-silver",ref_key:"hr",ref:v},null,512),s("div",{class:"px-2",ref_key:"dataList",ref:L},[s("div",u1,"\u0432\u043E\u043B\u043D\u0430 \u2116"+I(m(f).wave),1),_1,s("div",{ref_key:"itemsList",ref:g},[C(" \u0414\u0440\u043E\u043F: "),(e(!0),a(z,null,V(m(f).items,n=>(e(),a("div",{key:n.id,class:"ml-4 w-fit"},[K(w,{to:`/item/${n.id}`,class:"flex items-center"},{default:X(()=>[P(n==null?void 0:n.id)?(e(),a("img",{key:0,src:`.${P(n.id)}`,class:"mr-2 mb-2"},null,8,d1)):(e(),k(s1,{key:1,color:"purple",class:"mr-2 mb-2 h-16 w-16"})),C(" "+I(n.name)+" x% ",1)]),_:2},1032,["to"])]))),128))],512),(e(),k(H,{to:"body"},[s("div",{ref_key:"bossWrapper",ref:b,class:"pointer-events-none absolute inset-0"},[(e(),k(Y(m(h)),{class:"absolute inset-0 m-auto w-96 opacity-20"}))],512)]))],512)])}}};export{w1 as default};
