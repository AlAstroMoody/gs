import{o as l,a as n,b as e}from"./index.725b42b6.js";const o=["width","height","fill"],i=["fill"],c=["fill"],a=["fill"],d={__name:"QuestionIcon",props:{width:{default:36,type:Number},height:{default:64,type:Number},color:{default:"#000000",type:String}},setup(t){return(h,s)=>(l(),n("svg",{xmlns:"http://www.w3.org/2000/svg",width:t.width,height:t.height,viewBox:"0 0 736 1280",fill:t.color},[e("g",{transform:"translate(0,1280) scale(0.1,-0.1)",fill:t.color,stroke:"none"},[e("path",{fill:t.color,d:`M4130 12789 c-752 -55 -1507 -308 -2148 -721 -712 -459 -1304 -1102
      ...
      13z`},null,8,c),e("path",{fill:t.color,d:`M3747 859 c-105 -25 -237 -121 -290 -212 -98 -166 -65 -381 78 -516
      232 -220 623 -150 758 136 29 63 32 76 32 168 -1 133 -24 192 -111 285 -67 71
      -149 120 -234 139 -54 13 -180 12 -233 0z`},null,8,a)],8,i)],8,o))}};export{d as default};
