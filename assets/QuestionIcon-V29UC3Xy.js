import{v as n,x as l,y as e}from"./@vue-C6rom8q0.js";const o=["width","height","fill"],i=["fill"],c=["fill"],h=["fill"],d={__name:"QuestionIcon",props:{width:{default:36,type:Number},height:{default:64,type:Number},color:{default:"#000000",type:String}},setup(t){return(s,a)=>(l(),n("svg",{xmlns:"http://www.w3.org/2000/svg",width:t.width,height:t.height,viewBox:"0 0 736 1280",fill:t.color},[e("g",{transform:"translate(0,1280) scale(0.1,-0.1)",fill:t.color,stroke:"none"},[e("path",{fill:t.color,d:`M4130 12789 c-752 -55 -1507 -308 -2148 -721 -712 -459 -1304 -1102
      ...
      -149 120 -234 139 -54 13 -180 12 -233 0z`},null,8,h)],8,i)],8,o))}};export{d as _};
