<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15" class="lamp" @click="toggleTheme">
    <g>
      <path fill="var(--color-text)" d="M10.5,1.674V4c1.215,0.912,2,2.364,2,4c0,2.762-2.238,5
      ...
      <path fill="var(--color-text)" d="M8.5,7.003V0.997C8.5,0.446,8.056,0,7.5,0c-0.553,0
